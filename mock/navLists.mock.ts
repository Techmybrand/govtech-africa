		...
		QA: [
			{
				...
				answer: `Africa Govtech Week is a premier conference that brings together government 
				leaders, private sector innovators, development organizations and other participants to 
				explore the future of digital governance in Africa. The event fosters collaboration, 
				showcases cutting-edge government technology solutions, and drives discussions on policy, 
				innovation, and public sector digital transformation.`
			},
			{
			...
			},
			{
				...
				answer: `The event is designed for policymakers, government officials, technology leaders, 
				regulators, entrepreneurs, academia, development organizations and other participants 
				interested in driving digital transformation in governance.`
			},
		]
	},
	{
		...
		QA: [
			{
				question: 'When will registration for Africa Govtech Week open?',
				answer: 'Tickets for Africa Govtech Week are currently on sale through the official website.'
			},
			{
				question: 'How do I register for the event?',
				answer: `Registration can be completed online through the official Africa Govtech Week 
				website. Simply visit www.africagovtechweek.com and follow the steps to secure your spot.`,
			},
			{
				question: 'Is there a registration fee?',
				answer: `Yes, there are different registration fees for Delegate and VIP attendees. 
			...
			},
			{
				...
				answer: `No, this event is in-person only. However, daily recaps will be available on the 
				website.`
			},
			{
				question: 'What is the refund policy if I need to cancel my registration?',
				answer: `Full refunds are available for cancellation requests made within 48 hours of 
				receipt of the completed registration form subject to payment of a ten percent refund 
				processing fee. Cancellation requests made outside the 48-hour window or less than 30 
				days prior to the start of the event will not be eligible for a refund.`,
			},
			{
				question: 'How do I request a refund?',
				answer: `To request a refund, please submit a cancellation request to 
				info@africagovtechweek.com with your registration details. Eligible refunds will be 
				processed within 10 business days of receipt of the cancellation request.`
			},
			{
				question: 'Can I transfer my registration instead of cancelling?',
				answer: `Yes! If you are unable to attend, you may transfer your registration to a 
				colleague or another eligible participant at no extra cost at least seven days before 
				the date of the event. Any application for transfer of registration to another person 
				received later than seven days to before the date of the event will only be considered at 
				additional but minimal costs.`
			},
			{
				question: 'Are there exceptions to the refund policy?',
				answer: `Refund exceptions may be considered in cases of emergencies. Please contact us 
		...
		QA: [
			{
				...
				answer: `We welcome applications from thought leaders, policymakers, and industry experts. 
				Interested speakers should submit their proposals via info@africagovtechweek.com detailing 
				their expertise as aligned with the event programme.`
			},
			{
				question: 'How can my company become a sponsor or exhibitor?',
				answer: `Organizations looking to partner with Africa Govtech Week can explore our 
				sponsorship and exhibition packages. To receive a sponsorship prospectus, visit the 
				Partnership Page or contact our team at info@africagovtechweek.com`,
			},
		]
	},
	{
		...
		QA: [
			{
				...
				answer: `Gov-a-thon Africa is a high-stakes hackathon where developers, startups, and 
				innovators collaborate to create groundbreaking digital solutions tailored for public 
				sector transformation. The competition runs alongside Africa Govtech Week, with winning 
				teams receiving funding, mentorship, and potential government adoption of their solutions.`
			},
			{
				question: 'How can I participate in Gov-a-thon Africa?',
				answer: `Interested teams can apply online via the Gov-a-thon Africa Page, detailing 
				their expertise and proposed govtech solution. Selected team finalists will compete in 
				real-time challenges during the event.`,
			},
			{
				question: 'What is the Africa Govtech Co-Creation Lab?',
				answer: `The Co-Creation Lab is a collaborative initiative that convenes policymakers, 
				innovators, and researchers to develop Africa’s first Govtech Action Plan. The lab starts 
				ahead of the event and culminates in a high-profile presentation during the conference.`
			},
		]
	},
	{
		...
		QA: [
			{
				...
				answer: `Absolutely! Africa Govtech Week is structured to maximize networking through 
				industry meetups, side engagements, VIP receptions, and matchmaking sessions between 
				stakeholders.`
			},
			{
				question: 'Will meals and accommodation be provided?',
				answer: `While meals will be available for Delegate and VIP attendees, accommodation is 
				not included. However, we have partnered with top hotels offering discounted rates for 
				attendees. Send us an email at info@africagovtechweek.com or call us on 
				+234 810 287 5064  to get you set up.`,
			},
		]
	},
	{
		...
		QA: [
			{
				...
				answer: `The event focuses on digital transformation in governance, covering topics such 
				as AI in public service, data-driven decision-making, cybersecurity, digital identity, 
				smart infrastructure, and regulatory technology. Sessions will address both high-level 
				policy considerations and technical solutions tailored to Africa’s public sector.`
			},
			{
				question: 'Will the sessions be technical or policy-driven?',
				answer: `Africa Govtech Week will offer a balance between policy-focused discussions and 
				technical deep-dives. The keynote addresses and main panels will emphasize governance, 
				policy, and strategy, while breakout sessions and the Gov-a-thon Africa will focus on 
				practical, solution-driven conversations for technologists and innovators.`,
			},
			{
				question: 'Will there be country-specific discussions?',
				answer: `Yes. There will be dedicated country showcases where governments can present 
				their digital transformation journeys, share best practices, and discuss collaborative 
				opportunities.`
			},
			{
				question: 'Will there be post event recordings?',
				answer: `Yes. Key sessions will be recorded and made available on the Media Page 
				post-event.`
			},
			{
				question: 'Will the event support bilingual participation?',
				answer: `Yes. Key sessions will have simultaneous interpretation in English and French to 
				accommodate Africa’s diverse linguistic landscape.`
			},
		]
	},
	{
		...
		QA: [
			{
				...
				answer: `The event serves as a policy-shaping platform where governments can exchange 
				ideas, learn from best practices, and develop actionable recommendations. The outcomes 
				from sessions—including the Govtech Action Plan—will provide strategic direction for 
				Africa’s public sector digitization.`
			},
			{
				question: 'Can government representatives showcase their digital transformation initiatives?',
				answer: `Yes. There will be government showcase sessions where officials can present 
				their digital public infrastructure projects, share success stories, and discuss 
				challenges with industry experts and international partners. We encourage interested 
				government agencies to take advantage of our sponsorship and exhibition packages for more 
		...
		QA: [
			{
				...
				answer: `Development agencies, donors, and multilateral organizations can participate as 
				partners, speakers, or sponsors. The event provides a platform to align international 
				support with Africa’s digital governance needs. Visit the Partnership Page for more 
				details.`
			},
			{
				question: 'Are there investment opportunities in Govtech through this event?',
				answer: `Yes. Africa Govtech Week serves as a bridge between governments and investors, 
				facilitating discussions on Govtech funding, public-private partnerships, and 
				venture-backed innovation in digital governance.`,
			},
		]
	},
	{
		...
		QA: [
			{
				...
				answer: `The outcomes of Africa Govtech Week will be documented in a post-event Govtech 
				Report, summarizing key insights, policy recommendations, and next steps for stakeholders. The Africa Govtech Alliance will continue the momentum by fostering cross-sector collaboration beyond the event.`
			},
			{
				question: 'How can I stay engaged after the event?',
				answer: `Attendees can stay engaged by following the event pages on social media. The 
				Africa Govtech Alliance will also serve as a hub for continued dialogue, capacity-building, 
				and project implementation across the continent.`,
			},
		]
	}
]
